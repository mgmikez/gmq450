...
response = post('http://igeomedia.com:3030/test_prog_sylvain/update', data={'update': drop})
...
# On envoie ça par une requête post à Apache Jena
response = post('http://igeomedia.com:3030/test_prog_sylvain/update', data={'update': update})
