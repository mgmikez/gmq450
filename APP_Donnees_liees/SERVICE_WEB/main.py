...
QUERY_TEMPLATE_PARC = """
    ...
    prefix gev:   <https://igeomedia.com/~gev/> 
...
QUERY_TEMPLATE_PERSON = """
    prefix geo:   <http://www.opengis.net/ont/geosparql#>
	prefix rdf:   <http://www.w3.org/1999/02/22-rdf-syntax-ns#>
	prefix gev:   <http://www.igeomedia.com/~gev/>
...
def FusekiQuery(query, datasetname):
    ...
    response = post("http://igeomedia.com:3030/%s/query" % datasetname,  # Fuseki REST query endpoint
